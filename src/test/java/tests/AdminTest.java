...
//44"B1: Click vào button ""Profile & Settings"" tại thanh điều hướng bên trái màn hình.
//B2: Thực hiện click vào một user bất kì.
//B3: Click button ""Remove""."

//Cửa sổ "User Details" đóng lại thông tin user không còn trên listbox bên phải màn hình.
